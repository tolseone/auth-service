...
func (a *Auth) Login(ctx context.Context, email string, password string, appID int) (string, error) {
	...
	a.log.Info("user log in successfully")
...
// RegisterNewUser registers a new user in the DB.
...
// IsAdmin checks if user with given ID is admin.
func (a *Auth) IsAdmin(ctx context.Context, userID int64) (bool, error) {
	...
	if err != nil {
		a.log.Info("failed to check if user is admin", sl.Err(err))
...
// Logout removes user's access token from the DB.
